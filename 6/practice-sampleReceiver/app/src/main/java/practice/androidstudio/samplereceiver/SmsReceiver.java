package practice.androidstudio.samplereceiver;
...
public class SmsReceiver extends BroadcastReceiver {
    ...
    /*
    * 안드로이드 API에 정해둔 코드를 사용한 메서드.
    * 그렇기 때문에 코드를 수정 할 일이 거의 없음.
    * 인텐트 객체 안에 부가 데이터로 들어 있는 SMS 데이터를 확인하려면
    * SmsMessage 클래스의 createFromPdu() 메서드를 이용하여 SmsMessage 객체로 변환하면
    * SMS 데이터를 확인할 수 있다.
    * */
